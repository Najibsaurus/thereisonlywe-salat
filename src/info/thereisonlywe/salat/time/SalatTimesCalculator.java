...
License: GNU General protected License, ver 3
 ...
 */
public final class SalatTimesCalculator {
    ...
    protected int Time12NS; // 12-hour format with no suffix
    protected int Floating; // floating point number
    // Time Names
    ...
    protected SalatTimesCalculator() {
        // Initialize vars
    ...
    protected void setFajrAngle(double angle) {
        double[] params = {angle, -1, -1, -1, -1};
        setCustomParams(params);
    }

    // set the angle for calculating Maghrib
    protected void setMaghribAngle(double angle) {
    ...
    protected void setIshaAngle(double angle) {
    ...
    protected void setMaghribMinutes(double minutes) {
    ...
    protected void setIshaMinutes(double minutes) {
    ...
    protected String floatToTime24(double time) {
    ...
    protected String floatToTime12(double time, boolean noSuffix) {
    ...
    protected String floatToTime12NS(double time) {
    ...
    // Set time offsets
    protected void tune(int[] offsetTimes) {
    ...
    protected int getCalcMethod() {
        return calcMethod;
    }

    protected void setCalcMethod(int calcMethod) {
        this.calcMethod = calcMethod;
    }

    protected int getAsrJuristic() {
        return asrJuristic;
    }

    protected void setAsrJuristic(int asrJuristic) {
        this.asrJuristic = asrJuristic;
    }

    protected int getDhuhrMinutes() {
        return dhuhrMinutes;
    }

    protected void setDhuhrMinutes(int dhuhrMinutes) {
        this.dhuhrMinutes = dhuhrMinutes;
    }

    protected int getAdjustHighLats() {
        return adjustHighLats;
    }

    protected void setAdjustHighLats(int adjustHighLats) {
    ...
    protected void setTimeFormat(int timeFormat) {
    ...
    protected double getJDate() {
        return JDate;
    }

    protected void setJDate(double jDate) {
        JDate = jDate;
    }
    ...
    protected ArrayList<String> getTimeNames() {
        return timeNames;
    }
}
